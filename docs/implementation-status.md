...
- Current milestone: 1, typed chat MVP implemented locally with the mock provider; backend now loads local `backend/.env`; frontend production build and live Google chat are unverified.
